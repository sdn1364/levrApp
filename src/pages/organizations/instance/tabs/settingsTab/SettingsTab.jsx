...
import OrganizationsInformationTab from './components/organizationInformationTab/OrganizationsInformationTab'
import ManageAccessTab from './components/manageAccessTab/ManageAccessTab'

const SettingsTab = () => {

  return <Tabs orientation="vertical" defaultValue="settings" variant="pills" keepMounted={false}>
