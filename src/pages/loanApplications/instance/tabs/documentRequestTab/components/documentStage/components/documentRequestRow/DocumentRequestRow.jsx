...
const DocumentRequestRow = ({ docReq, innerRef, provided, snapshot }) => {
  ...
  return (
    <Accordion.Item {...provided.draggableProps} {...provided.dragHandleProps} sx={{ overflow: 'hidden' }} ref={innerRef} className={cx({ [classes.itemDragging]: snapshot.isDragging })} value={`${docReq.id}`}>
